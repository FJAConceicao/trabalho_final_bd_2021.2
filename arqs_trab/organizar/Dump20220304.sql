...
--
-- Host: localhost    Database: cake_cms
-- ------------------------------------------------------
...
CREATE TABLE `product` (
  ...
  `fk_info_info_PK` int(11) DEFAULT NULL,
  ...
  CONSTRAINT `FK_Product_4` FOREIGN KEY (`fk_Manufacturer_Id`) REFERENCES `manufacturer` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `review` (
  ...
  `did_purchase` tinyint(1) DEFAULT NULL,
...
CREATE TABLE `sells` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_sells_1` (`fk_Product_Id`),
  KEY `FK_sells_2` (`fk_Store_Id`),
  CONSTRAINT `FK_sells_1` FOREIGN KEY (`fk_Product_Id`) REFERENCES `product` (`id`),
  CONSTRAINT `FK_sells_2` FOREIGN KEY (`fk_Store_Id`) REFERENCES `store` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-03-04 13:11:31
